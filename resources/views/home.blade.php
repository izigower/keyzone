...
@section('styles')
    <style>
        ...
        .hero-content.no-cards .hero-text {
            max-width: 800px;
        }

        .hero-content.no-cards .hero-subtitle {
            margin-left: auto;
            margin-right: auto;
        }

        .hero-content.no-cards .hero-actions {
            justify-content: center;
        }

        .hero-content.no-cards .hero-stats {
            justify-content: center;
        }

        .hero-content.no-cards .hero-stat {
            text-align: center;
        }
        ...
        @keyframes card-float-1 {
            ...
            0%,
            100% {
                transform: rotate(-6deg) translateX(-40px) translateY(0);
            }

            50% {
                transform: rotate(-6deg) translateX(-40px) translateY(-15px);
            }
        }
...
@section('content')
    ...
    <section class="hero">
        <div class="hero-bg">
            ...
            <div class="geo-shape"
                style="width: 120px; height: 120px; top: 60%; right: 10%; animation-delay: -5s; border-color: rgba(236, 72, 153, 0.1);">
            </div>
            <div class="geo-shape" style="width: 80px; height: 80px; bottom: 15%; left: 30%; animation-delay: -10s;"></div>
        </div>

        <div class="hero-content {{ $tendances->count() < 3 ? 'no-cards' : '' }}">
            <div class="hero-text">
                ...
                <p class="hero-subtitle">
                    Recevez vos cles d'activation instantanement. Des milliers de jeux PC, Xbox, PlayStation et Nintendo
                    Switch a prix reduit.
                </p>
            ...
            <div class="hero-cards">
                @foreach($tendances->take(3) as $i => $game)
                    <div class="hero-featured-card">
                        <img src="{{ $game->image ?? 'https://via.placeholder.com/280x160/1e2134/8b5cf6?text=' . urlencode($game->nom) }}"
                            alt="{{ $game->nom }}">
                        <div class="card-info">
                ...
                <div class="game-card">
                    <div class="game-card-image">
                        ...
                        @if($produit->reduction > 0)
                            <span class="game-card-badge badge-promo"
                                style="left: auto; right: 0.8rem;">-{{ $produit->reduction }}%</span>
                        @endif
                        <img src="{{ $produit->image ?? 'https://via.placeholder.com/460x215/1e2134/8b5cf6?text=' . urlencode($produit->nom) }}"
                            alt="{{ $produit->nom }}">
                    ...
                    <div class="game-card-body">
                        ...
                        <div class="game-card-pricing">
                            ...
                            @if($produit->prix_original)
                                <span class="game-card-old-price">{{ number_format($produit->prix_original, 2, ',', ' ') }}
                                    &euro;</span>
    ...
    <section class="section-why">
        <div class="section-header" style="max-width: 1400px; margin: 0 auto 3.5rem; padding: 0;">
            <div>
                ...
                <p style="color: #94a3b8; margin-top: 0.5rem; font-size: 1rem;">La marketplace de confiance pour vos cles de
                    jeux video</p>
            </div>
        </div>
        <div class="why-grid">
            <div class="why-card">
                ...
                <p>Recevez votre cle d'activation en quelques secondes, directement par email et dans votre espace client.
                </p>
            </div>
            <div class="why-card">
    ...
    <section class="section-steps" id="how-it-works">
        <div class="section-header" style="max-width: 1100px; margin: 0 auto 4rem; text-align: center; display: block;">
            <h2 style="font-size: 2.2rem;"><span class="section-icon"><i class="fas fa-magic"></i></span>COMMENT CA MARCHE ?
            </h2>
